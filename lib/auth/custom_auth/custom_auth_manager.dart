...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    voteForGoatAuthUserSubject.add(
      VoteForGoatAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<VoteForGoatAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  VoteForGoatAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = VoteForGoatAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    voteForGoatAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
VoteForGoatAuthUser? currentUser;
