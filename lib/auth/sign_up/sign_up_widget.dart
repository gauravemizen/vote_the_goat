...
// }
//
// class _SignUpWidgetState extends State<SignUpWidget> with RouteAware {
...
//                                       focusNode:
//                                           _model.copasswordFieldFocusNode,
//                                       autofocus: false,
//                                       obscureText:
...
//                                                   .copasswordFieldTextController
//                                                   .text,
//                                             );
//
//                                             _shouldSetState = true;
//                                             if ((_model.signUpRes?.succeeded ??
//                                                 true)) {
//                                               await Future.wait([
//                                                 Future(() async {
          ...
          children: [
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: ListView(
                  padding: const EdgeInsets.only(left: 3.0, right: 3.0, top: 3.0, bottom: 180.0),
                  children: [
                    Form(
                      key: _model.formKey,
                      autovalidateMode: AutovalidateMode.disabled,
                            ...
                            child: SizedBox(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  suffixIcon: InkWell(
                                    onTap: () => safeSetState(
                                          () => _model.copasswordFieldVisibility = !_model.copasswordFieldVisibility,
                                    ),
                                    focusNode: FocusNode(skipTraversal: true),
                                    child: Icon(
                                      _model.copasswordFieldVisibility
                                ...
                                cursorColor: FlutterFlowTheme.of(context).primaryText,
                                validator: _model.copasswordFieldTextControllerValidator.asValidator(context),
                              ),
                            ),
                          ),
                          Container(
