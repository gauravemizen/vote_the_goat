...
//
//     double _calculateIndicatorOffset(BuildContext context) {
//       final totalWidth = MediaQuery.of(context).size.width; // <-- full width
//       final perItemWidth = totalWidth / widget.items.length;
//       return perItemWidth * _pos + (perItemWidth - 20) / 2; // 20 = image width
//     }
//
...
//               //         child: Stack(
//               //           children: [
//               //             // Keep the background curve (optional)
//               //             // CustomPaint(
//               //             //   painter: CurvedNavPainter(
//               //             //     startingLoc: _pos,
//               //             //     itemsLength: widget.items.length,
...
//               //                   itemsLength: widget.items.length,
//               //                   color: widget.backgroundColor,
//               //                   indicatorColor: Colors.transparent, // hide painted indicator
//               //                   textDirection: TextDirection.LTR,
//               //                   indicatorSize: widget.indicatorSize,
//               //                   borderRadius: widget.borderRadius,
//               //                 ),
...
//               //               child: Image.asset(
//               //                 'assets/images/basketball.png', // replace with your asset
//               //                 width: 20,
//               //                 height: 20,
//               //               ),
//               //             ),
...
//                       color: Colors.transparent, // Canvas will draw background
//                     ),
//                     child: CustomPaint(
//                       painter: CurvedNavPainter(
//                         startingLoc: _pos,
...
//                         color: widget.backgroundColor,
//                         indicatorColor:
//                             Colors.transparent, // we'll use image instead
//                         textDirection: TextDirection.LTR,
//                         indicatorSize: widget.indicatorSize,
//                         borderRadius: widget.borderRadius,
//                       ),
...
//                   left: _calculateIndicatorOffset(context),
//                   bottom:
//                       widget.height - 11, // adjust vertical position of image
//                   child: Image.asset(
