...
void debugLogEnvironmentValue(FFDevEnvironmentValues environmentValues) {
  debouncedDebugLogging(
      '6d3dc83edc13c864d216ff73835780156c4e919f',
      () => {
            'event_type': 'variable',
            'data_source': 'environmentValue',
            'data': EnvironmentValueDebugData(
                    values: environmentValues.toDebugSerializableMap())
                .serializedBufferString,
          });
}
