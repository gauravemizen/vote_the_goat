...
class HomeOnboardingWidget extends StatefulWidget {
  const HomeOnboardingWidget({super.key});

  static String routeName = 'homeOnboarding';
  static String routePath = '/homeOnboarding';

  @override
  State<HomeOnboardingWidget> createState() => _HomeOnboardingWidgetState();
}

class _HomeOnboardingWidgetState extends State<HomeOnboardingWidget>
    with RouteAware {
  late HomeOnboardingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeOnboardingModel());
  }
  ...
  @override
  void didUpdateWidget(HomeOnboardingWidget oldWidget) {
