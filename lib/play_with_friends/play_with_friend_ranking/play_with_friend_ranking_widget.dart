...
//   bool isLoading = true;
//
// // Add to your _PlayWithFriendRankingWidgetState
//
//   bool get isRankingError {
//     final json = _model.apiResultk4i?.jsonBody;
//     return json != null &&
//         getJsonField(json, r'$.status') == 'error' &&
//         getJsonField(json, r'$.status_code') == 404;
//   }
//
//   String get errorMessage {
//     final json = _model.apiResultk4i?.jsonBody;
//     return json != null ? getJsonField(json, r'$.message')?.toString() ?? '' : '';
//   }
//
//   // Helper methods to check ranking status
//   bool get isRankingClosed {
//     if (_model.apiResultk4i?.jsonBody != null) {
//       final jsonBody = _model.apiResultk4i!.jsonBody;
//       return getJsonField(jsonBody, r'$.ranking_open') == false;
//     }
//     return false;
//   }
//
//   String get rankingMessage {
//     if (_model.apiResultk4i?.jsonBody != null) {
//       final jsonBody = _model.apiResultk4i!.jsonBody;
//       return getJsonField(jsonBody, r'$.message')?.toString() ?? '';
//     }
//     return '';
//   }
//
//   String get rankingAvailableAt {
//     if (_model.apiResultk4i?.jsonBody != null) {
//       final jsonBody = _model.apiResultk4i!.jsonBody;
//       return getJsonField(jsonBody, r'$.ranking_available_at')?.toString() ??
//           '';
//     }
//     return '';
//   }
...
//
//       // Print the response
//       print('API Response Status: ${_model.apiResultk4i?.statusCode}');
//       print('API Response Body: ${_model.apiResultk4i?.jsonBody}');
//
//
//       setState(() => isLoading = false);
//
...
//                             ),
//                             Expanded(
//                               child: !isLoading && isRankingClosed
//                                   ? Center(
//                                       child: Padding(
...
//                                                   ),
//                                             ),
//                                             if (rankingAvailableAt
//                                                 .isNotEmpty) ...[
//                                               const SizedBox(height: 10.0),
//                                               Text(
//                                                 'Available at: $rankingAvailableAt',
//                                                 textAlign: TextAlign.center,
//                                                 style: FlutterFlowTheme.of(
//                                                         context)
//                                                     .bodyMedium
...
//                                                                           ),
//                                                                           color:
//                                                                               FlutterFlowTheme.of(context).oposite,
//                                                                           fontSize:
//                                                                               16.0,
//                                                                           letterSpacing:
//                                                                               0.0,
...
//                                                                         child:
//                                                                             Text(
//                                                                           getJsonField(player, r'$.player_name')
//                                                                               .toString(),
//                                                                           style: FlutterFlowTheme.of(context)
//                                                                               .titleMedium
//                                                                               .override(
                ...
                Padding(
                  ...
                  child: isLoading
                    ...
                    children: [
                      ...
                      Expanded(
                        child: !isLoading && (isRankingClosed || isRankingError)
                            ? Center(
                          child: Padding(
                            padding: const EdgeInsets.all(20.0),
                            child: Column(
