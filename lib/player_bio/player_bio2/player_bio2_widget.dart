...
class PlayerBio2Widget extends StatefulWidget {
  const PlayerBio2Widget({super.key});

  static String routeName = 'playerBio2';
  static String routePath = '/playerBio2';

  @override
  State<PlayerBio2Widget> createState() => _PlayerBio2WidgetState();
}

class _PlayerBio2WidgetState extends State<PlayerBio2Widget>
    with TickerProviderStateMixin, RouteAware {
  late PlayerBio2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlayerBio2Model());
  ...
  @override
  void didUpdateWidget(PlayerBio2Widget oldWidget) {
