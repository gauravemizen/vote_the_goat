...
//                                     print('========================================');
//                                     print('🔄 DRAG & DROP EVENT STARTED');
//                                     print('========================================');
//                                     print('📍 Old Index: $reorderableOldIndex');
//                                     print('📍 Raw New Index: $reorderableNewIndex');
//
//                                     // ✅ Fix the Flutter index shift issue
//                                     int adjustedIndex = reorderableNewIndex;
//                                     if (reorderableOldIndex < reorderableNewIndex) {
//                                       adjustedIndex -= 1;
//                                     }
//
//                                     print('📍 Adjusted Index (0-based): $adjustedIndex');
//
//                                     final draggedPlayer = players.elementAtOrNull(reorderableOldIndex);
//                                     final playerId = getJsonField(draggedPlayer, r'''$.player.player_id''');
//                                     final firstName = getJsonField(draggedPlayer, r'''$.player.first_name''');
//                                     final lastName = getJsonField(draggedPlayer, r'''$.player.last_name''');
//                                     final oldPosition = getJsonField(draggedPlayer, r'''$.position''');
//                                     final newPosition = adjustedIndex + 1; // ✅ 1-based position for API
//
//                                     print('👤 Player ID: $playerId');
//                                     print('👤 Player Name: $firstName $lastName');
//                                     print('🔢 Old Position: $oldPosition');
//                                     print('🔢 New Position (1-based): $newPosition');
//                                     print('📊 Total Players: ${players.length}');
//                                     print('========================================');
//
//                                     print('API Request Body:');
//                                     print('position: $newPosition');
//                                     print('authToken: ${FFAppState().authToken}');
//                                     print('playerId: $playerId');
//
//                                     _model.apiResult156 = await DashboardGroup.rankingPostCall.call(
...
//                                     print('📡 API RESPONSE');
//                                     print('========================================');
//                                     print('✅ Success: ${_model.apiResult156?.succeeded}');
//                                     print('📄 Response Body: ${_model.apiResult156?.jsonBody}');
//                                     print('🔢 Status Code: ${_model.apiResult156?.statusCode}');
//                                     print('💬 Message: ${getJsonField((_model.apiResult156?.jsonBody ?? ''), r'''$.message''')}');
//                                     print('========================================');
//
//                                     if ((_model.apiResult156?.succeeded ?? false)) {
//                                       print('✅ API call succeeded - refreshing list');
//                                       safeSetState(() => _model.apiRequestCompleter = null);
//                                       await _model.waitForApiRequestCompleted();
//                                       ScaffoldMessenger.of(context).showSnackBar(
//                                         SnackBar(
//                                           content: Text(
//                                             getJsonField((_model.apiResult156?.jsonBody ?? ''), r'''$.message''').toString(),
...
//                                       );
//                                     } else {
//                                       print('❌ API call failed - showing error');
//                                       ScaffoldMessenger.of(context).showSnackBar(
//                                         SnackBar(
//                                           content: Text(
//                                             getJsonField((_model.apiResult156?.jsonBody ?? ''), r'''$.message''').toString(),
...
//                                       );
//                                       safeSetState(() {});
//                                       print('🔙 Returning early due to API failure');
//                                       return;
//                                     }
//
//                                     print('⏳ Waiting for API request to complete...');
//                                     safeSetState(() => _model.apiRequestCompleter = null);
//                                     await _model.waitForApiRequestCompleted(minWait: 1000, maxWait: 1200);
//
//                                     print('✅ Drag & drop operation completed');
//                                     print('========================================\n');
//                                     safeSetState(() {});
//                                   },
//
