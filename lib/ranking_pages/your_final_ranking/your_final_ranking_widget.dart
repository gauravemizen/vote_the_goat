...
// Show loader, or "No ranking found", or the normal ranking UI
                  _loading
                      ? const Center(
                          child: CubeGridLoader(
                            size: 40.0,
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
// podium columns assume _rankings has at least 3 items
// since we already checked _rankings.isNotEmpty above, safe here
// (the size check was performed earlier)
// second place (index 1) - guard access with length check just in case
                                            Column(
                                              mainAxisSize: MainAxisSize.max,
                                              children: [
                                                Padding(
