...
class _NewPasswordWidgetState extends State<NewPasswordWidget> with RouteAware {
  ...
  void initState() {
    ...
    _model.passwordFieldTextController3 ??= TextEditingController()
      ..addListener(() {
        debugLogWidgetClass(_model);
      });
    _model.passwordFieldFocusNode3 ??= FocusNode();
  }
  ...
  @override
  void didUpdateWidget(NewPasswordWidget oldWidget) {
                        ...
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: TextFormField(
                              ...
                              focusNode: _model.passwordFieldFocusNode3,
                              autofocus: false,
                              obscureText: !_model.passwordFieldVisibility3,
                              decoration: InputDecoration(
                                isDense: true,
                                labelStyle: FlutterFlowTheme.of(context)
                                    .labelMedium
                                ...
                                suffixIcon: InkWell(
                                  onTap: () => safeSetState(
                                    () => _model.passwordFieldVisibility3 =
                                        !_model.passwordFieldVisibility3,
                                  ),
                                  focusNode: FocusNode(skipTraversal: true),
                                  child: Icon(
